...
class TentArticle(models.Model):
    ...
    armatures_amount_available= fields.Integer(string = 'Armatures disponibles', default = self.rec. armatures_amount_total)
    pignons_amount_available = fields.Integer(string = 'Pignons disponibles', default = self.rec.pignon_amount_total)
