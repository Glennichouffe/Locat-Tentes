...
class TentArticle(models.Model):
    ...
    price_week_without_installation = fields.Float('Prix pour une semaine de location sans installation')
    price_week_with_installation = fields.Float('Prix pour une semaine de location avec installation')
